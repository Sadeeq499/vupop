      ...
      bottomNavigationBar: Obx(
        () => BottomNavigationBar(
          ...
          onTap: (index) {
            ...
            if (index == 2 && Get.find<RecordingController>().isRecording.value) {
              ...
              /*Get.find<RecordingController>().resetRecording();
              Get.find<RecordingController>().onInit();*/
            } else if (controller.previousSelectedIndex.value == 2 && index == 2 && !Get.find<RecordingController>().isRecording.value) {
          ...
          items: [
            ...
            BottomNavigationBarItem(
              ...
              icon: Obx(
                () => GestureDetector(
                    onLongPress: Get.find<RecordingController>().isRecording.value
                        ? () {
                            Get.find<RecordingController>().resetRecording();
                            Get.find<RecordingController>().initalization();
                          }
                        : null,
                    child: Get.find<RecordingController>().isRecording.value
                        ? CountDownWidget(controller: Get.find<RecordingController>())
                        : Image.asset(
                            kRecording,
                            width: 65.w,
                            height: 65.w,
            ...
            BottomNavigationBarItem(
              icon: _buildNavItem(kMessageInactive, kMessageActive, controller.selectedIndex.value == 3),
              label: ' ',
            ),
            BottomNavigationBarItem(
              icon: _buildNavItem(kProfileInactive, kUserActive, controller.selectedIndex.value == 4),
              label: ' ',
            ),
          ],
        ),
