...
class FollowerSwipeViewPosts extends GetView<FollowersProfileController> {
  const FollowerSwipeViewPosts({super.key});
              ...
              child: Obx(
                () => Swiper(
                  ...
                  onIndexChanged: (index) async {
                    ...
                    if (index == controller.followerPosts.length - 1) {
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    final post = controller.followerPosts[controller.tappedPostIndex.value];
                    return Obx(
                      () => controller.isVideoLoading.value
                          ? const Center(child: CircularProgressIndicator())
                          : VideoPlayerBottomSheet(
                              isPlaying: controller.isPlaying.value,
                              onPlayButtonTap: (bool v) {
                              ...
                              post: controller.followerPosts[controller.tappedPostIndex.value],
                              likeDislikeTapped: () {
                              ...
                              onFollowButtonTap: () async {
                                await controller.updateFollowStatus(
                                  followedUserId: controller.followerPosts[controller.tappedPostIndex.value].userId.id,
                                );
                              },
                              onProfileTap: () {
                                Get.toNamed(kFollowersProfileScreen, arguments: controller.followerPosts[controller.tappedPostIndex.value].userId.id);
                              },
                              followedUserId: controller.followerPosts[controller.tappedPostIndex.value].userId.id,
